//
//  AWHBPBAdminAreaCollectionHeaderLayout.h
//  AWHBPublicBusiness
//
...
@protocol AWHBPBAdminHorizontalCollectionLayoutDelegate <NSObject>
...
@interface AWHBPBAdminAreaCollectionHeaderLayout : UICollectionViewFlowLayout
...
@property (nonatomic, weak) id<AWHBPBAdminHorizontalCollectionLayoutDelegate> delegate;

@property (nonatomic, copy) void (^refreshFinishBlock)(CGFloat collectionViewHeight);
