...
typedef NS_ENUM(NSInteger, AWHBPBAlbumType) {
    AWHBPBAlbumTypeDefault   = 0, // 默认
    AWHBPBAlbumTypeCumstom   = 1  // 自定义
};


@interface AWHBPBImageModel : NSObject
...
@interface AWHBPBMLPhotoImageHelper : NSObject
